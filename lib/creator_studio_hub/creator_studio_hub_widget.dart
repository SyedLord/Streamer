...
class CreatorStudioHubWidget extends StatefulWidget {
  const CreatorStudioHubWidget({super.key});

  static String routeName = 'CreatorStudioHub';
  static String routePath = '/creatorStudioHub';

  @override
  State<CreatorStudioHubWidget> createState() => _CreatorStudioHubWidgetState();
}

class _CreatorStudioHubWidgetState extends State<CreatorStudioHubWidget> {
  late CreatorStudioHubModel _model;
