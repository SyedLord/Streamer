...
import 'creator_studio_hub_copy_model.dart';
export 'creator_studio_hub_copy_model.dart';

class CreatorStudioHubCopyWidget extends StatefulWidget {
  const CreatorStudioHubCopyWidget({super.key});

  static String routeName = 'CreatorStudioHubCopy';
  static String routePath = '/creatorStudioHubCopy';

  @override
  State<CreatorStudioHubCopyWidget> createState() =>
      _CreatorStudioHubCopyWidgetState();
}

class _CreatorStudioHubCopyWidgetState
    extends State<CreatorStudioHubCopyWidget> {
  late CreatorStudioHubCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatorStudioHubCopyModel());
                          ...
                          children: [
                            if (FFAppState().selectedVideoPath != '')
                              Container(
                                ...
                                height: 300.0,
                                child: custom_widgets.LocalVideoPreview2(
                                  width: double.infinity,
                                  height: 300.0,
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    _model.pickedNewVideo =
                                        await actions.pickSafeVideoPath2();
                                    FFAppState().selectedVideoPath =
                                        _model.pickedNewVideo!;
                                    safeSetState(() {});
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'For the best stability, ensure your upload speed is at least 15 Mbps.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                            font: GoogleFonts.inter(
