...
import 'creator_studio_hub2_copy_model.dart';
export 'creator_studio_hub2_copy_model.dart';

class CreatorStudioHub2CopyWidget extends StatefulWidget {
  const CreatorStudioHub2CopyWidget({super.key});

  static String routeName = 'CreatorStudioHub2Copy';
  static String routePath = '/creatorStudioHub2Copy';

  @override
  State<CreatorStudioHub2CopyWidget> createState() =>
      _CreatorStudioHub2CopyWidgetState();
}

class _CreatorStudioHub2CopyWidgetState
    extends State<CreatorStudioHub2CopyWidget> {
  late CreatorStudioHub2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatorStudioHub2CopyModel());
